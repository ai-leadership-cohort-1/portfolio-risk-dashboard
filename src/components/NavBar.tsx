...
const NAV_ITEMS = [
  ...
  { href: "/board-summary", label: "Board Summary" },
];
      ...
      <header className="border-b border-[var(--border)] bg-[var(--surface)]">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
          <div className="flex items-center gap-3">
            <div className="relative h-7 w-7 rounded bg-[var(--accent)]">
            ...
            <div>
              ...
              <div className="text-xs text-[var(--muted)]">Lending &amp; credit risk prototype</div>
            </div>
          </div>
